...
# Get the API key for using the OpenAI GPT Model
openai_key = os.getenv("OPENAI_API_KEY")

# Pass the Specific Model to variable 
...
# libraries for calling the sql_agent, creating database and toolkit using the csv file
...
# creating a SQL database from the file path/url
db = SQLDatabase.from_uri(f"sqlite:///{database_file_path}")
toolkit = SQLDatabaseToolkit(db=db, llm=model)

QUESTION = """
              What is the highest salary by department , and give me the number?"
