...
# res = agent.invoke("Which department is getting the max Longevity pay")

# print(res)

# Let's add some pre and sufix prompt
...
CSV_PROMPT_PREFIX = """
First state the Question and get the column names, then and answer the question.
"""
...
QUESTION = "Which grade has the lowest average base salary, and compare the average female pay vs male pay?"
